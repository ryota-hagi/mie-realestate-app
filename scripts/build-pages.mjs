...
.global-header { background: #fff; border-bottom: 1px solid #e5e7eb; padding: 12px 0; position: sticky; top: 0; z-index: 50; }
...
.global-nav a, .global-nav span { color: #6b7280; text-decoration: none; font-size: 13px; font-weight: 500; padding: 4px 10px; border-radius: 6px; }
.global-nav a:hover { background: #f3f4f6; color: #1f2937; }
.global-nav .active { color: #2563eb; font-weight: 700; background: #eff6ff; }
.site-logo img { height: 44px; width: auto; display: block; }
.global-hamburger { display: none; align-items: center; justify-content: center; width: 36px; height: 36px; border-radius: 8px; background: #f3f4f6; border: 1px solid #e5e7eb; font-size: 18px; color: #374151; cursor: pointer; margin-left: auto; }
    ...
    <div style="display:flex;flex-direction:column;gap:12px;">
      ${builderEvents.map(ev => {
        ...
        <div>
          ...
          ${ev.url ? `<a href="${escHtml(ev.url)}" target="_blank" rel="noopener" style="display:inline-block;margin-top:6px;margin-left:4px;font-size:11px;color:#2563eb;text-decoration:none;font-weight:500;">🔗 ${ev.sourceType === 'instagram' ? 'Instagram投稿' : ev.sourceType === 'x' ? 'X投稿' : '公式サイト'}で詳細を見る</a>` : ''}
        </div>
      </div>`;
      }).join('\n      ')}
    </div>
...
function ecSelectDay(dateStr){
  ...
  dayEvents.forEach(function(e){
    ...
    var srcLink = e.url ? '<a href="'+e.url+'" target="_blank" rel="noopener" style="display:inline-block;margin-top:8px;font-size:13px;color:#2563eb;text-decoration:none;font-weight:600;">🔗 '+srcLabel+'</a>' : '';
...
function ecRenderList(){
  ...
  sorted.forEach(function(e){
    ...
    var srcLink2 = e.url ? '<a href="'+e.url+'" target="_blank" rel="noopener" style="display:inline-block;margin-top:8px;font-size:13px;color:#2563eb;text-decoration:none;font-weight:600;">🔗 '+srcLabel2+'</a>' : '';
